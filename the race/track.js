...
function startRace(){
    ...
    TweenMax.to("#car2",2,{x:490,ease:Sine.easeOut});
     ...
     TweenMax.to("#car2",1.5,{x:500, y:-320,delay:1.6, ease:Sine.easeOut});
      TweenMax.to("#car2",.5,{rotation:-180,delay:2,ease:Sine.easeOut});
    TweenMax.to("#car2",1.6,{x:-100, y:-280,delay:2.6, ease:Sine.easeOut});
